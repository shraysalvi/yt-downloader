                    ...
                    <form className="relative flex flex-col sm:block" onSubmit={handleSubmit}>
                        <div className="relative transition-all backdrop-blur-xl rounded-full overflow-hidden">
                            <input
                                ...
                                className="w-full bg-white/5 text-white py-4 px-6 pr-6 sm:pr-32 rounded-full outline-none border border-white/10 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.1)] focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/50 transition-all"
                                type="text"
                            />
